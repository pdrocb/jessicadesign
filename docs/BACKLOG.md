...
- **Pedirle a la clienta las fotos del Look Book.** Son **siete**: tres filas (2 + 2 + 3). Dos deben recortar bien a **3/2 apaisado** (celdas anchas de 8 columnas), dos ser **verticales** 3/4, y tres aguantar **cuadrado** 1:1. Faltan también los **nombres reales de álbum** — hoy son descriptivos. URGENTE: **las 10 fotos del sitio se repiten entre secciones** (7 de ellas aparecen dos o tres veces); con 12 huecos y 10 imágenes provisionales del Wix no hay forma de evitarlo hasta que ella entregue material nuevo.
